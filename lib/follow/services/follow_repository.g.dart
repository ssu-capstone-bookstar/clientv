...
class _FollowRepository implements FollowRepository {
  ...
  @override
  Future<ResponseForm<void>> follow(int followMemberId) async {
  ...
  @override
  Future<ResponseForm<void>> unfollow(int followMemberId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ResponseForm<List<FollowResponse>>> getFollowing(int memberId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ResponseForm<List<FollowResponse>>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResponseForm<List<FollowResponse>> _value;
    try {
      _value = ResponseForm<List<FollowResponse>>.fromJson(
        _result.data!,
  ...
  @override
  Future<ResponseForm<List<FollowResponse>>> getFollowers(int memberId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ResponseForm<void>> deleteFollower(int followerID) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
...
String _$followRepositoryHash() => r'1a9938de1974f2ab591e256ef63d54d946a2b50b';
