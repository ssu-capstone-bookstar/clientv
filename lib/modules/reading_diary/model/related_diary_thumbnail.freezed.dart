...
/// Adds pattern-matching-related methods to [RelatedDiaryThumbnail].
extension RelatedDiaryThumbnailPatterns on RelatedDiaryThumbnail {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RelatedDiaryThumbnail value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RelatedDiaryThumbnail() when $default != null:
