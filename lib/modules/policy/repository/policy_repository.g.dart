...
class _PolicyRepository implements PolicyRepository {
  _PolicyRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ResponseForm<Policy>> getPolicy() async {
    ...
    final _options = _setStreamType<ResponseForm<Policy>>(
    ...
    late ResponseForm<Policy> _value;
    try {
      _value = ResponseForm<Policy>.fromJson(
        _result.data!,
...
String _$policyRepositoryHash() => r'9cb41371c28a7167e9a33495d73769642c7b59ff';
