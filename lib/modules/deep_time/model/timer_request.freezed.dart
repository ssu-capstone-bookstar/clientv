...
/// Adds pattern-matching-related methods to [TimerRequest].
extension TimerRequestPatterns on TimerRequest {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TimerRequest value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TimerRequest() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int seconds)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
