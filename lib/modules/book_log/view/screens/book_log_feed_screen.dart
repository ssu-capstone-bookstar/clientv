...
class BookLogFeedScreen extends BaseScreen {
  ...
  @override
  BaseScreenState<BookLogFeedScreen> createState() => _BookLogFeedScreenState();
}

class _BookLogFeedScreenState extends BaseScreenState<BookLogFeedScreen> {
  @override
